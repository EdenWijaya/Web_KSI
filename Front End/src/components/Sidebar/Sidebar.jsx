...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  return (
    <div
      className={`fixed inset-y-0 left-0 w-60 bg-secondary2 text-white transition-transform transform ${
    ...
    >
      ...
      <nav className="flex flex-col space-y-4 px-6">
        ...
        <Link
          ...
          onClick={toggleSidebar}
        >
          <IoMdArrowRoundBack className="mr-3 text-white" />{" "}
      ...
      <div className="mt-auto flex justify-center px-6 py-4">
        <button className="secondary-btn w-full" onClick={LogoutHandler}>
