...
var _adminAccount = require("./adminAccount.js");
...
var adminAuth = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var body, data, admin, isPasswordValid, payload, secretKey, expiresIn, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          return (0, _adminAccount.getAdminAccount)();
        case 5:
          data = _context.sent;
          admin = JSON.parse(data);
          _context.prev = 7;
          _context.next = 10;
          return _bcrypt["default"].compare(body.password, admin.password);
        case 10:
  ...
  return function adminAuth(_x, _x2) {
